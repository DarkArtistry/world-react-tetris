...
Please view [README.md](https://github.com/DarkArtistry/world-react-tetris/blob/master/README.md)
...
该代码基于 [https://chvin.github.io/react-tetris/](https://chvin.github.io/react-tetris/)。
欢迎任何人贡献应用程序的皮肤。


戳：[https://tetris-58968.firebaseapp.com/?lan=en](https://tetris-58968.firebaseapp.com/?lan=en) 玩一玩！

----
断电。通过订阅 `store.subscribe`，将state储存在localStorage，精确记录所有状态。网页关了刷新了、程序崩溃了、手机没电了，重新打开连接，都可以继续。
